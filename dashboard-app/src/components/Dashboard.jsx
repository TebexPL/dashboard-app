...
export function Dashboard() {
   ...
   const getDataOnDate = async (date) => {
       const res = await fetch("https://twwai-dashboard-app.herokuapp.com/api/params/search/" + date)
  ...
  useEffect(() => {
    const socket = io("https://twwai-dashboard-app.herokuapp.com/", {
    ...
    socket.on("currentState", data => {
       ...
       const fetchAir = async () => {
           ...
           const currentRes = await fetch("https://twwai-dashboard-app.herokuapp.com/api/params/last")
